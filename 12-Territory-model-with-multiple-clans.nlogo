...
;; TO REPORT CLAN-SPECIFIC RESOURCES

to-report resources-of-color [clr]
  report sum [resources] of patches with [pcolor = clr]
end

to-report green-resources
  report resources-of-color green
end

to-report blue-resources
  report resources-of-color blue
end

to-report red-resources
  report resources-of-color red
end

to-report yellow-resources
  report resources-of-color yellow
end

;; TO REPORT CLAN-OCCUPIED PATCHES
to-report red-patches
...
to-report blue-patches
  report patches with [pcolor = blue]
end

to-report black-patches
  report patches with [pcolor = black]
end

to-report grey-patches
  report patches with [pcolor = grey]
end

to-report white-patches
  report patches with [pcolor = white]
end

to-report yellow-patches
...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "set-plot-y-range 0 5\nhistogram [energy] of turtles"
...
"" ""
PENS
"Green" 1.0 2 -15040220 true "" "plot sum [energy] of turtles with [color = green]"
"Yellow" 1.0 2 -1184463 true "" "plot sum [energy] of turtles with [color = yellow]"
"Blue" 1.0 2 -14070903 true "" "plot sum [energy] of turtles with [color = blue]"
"Red" 1.0 2 -5298144 true "" "plot sum [energy] of turtles with [color = red]"
...
"" ""
PENS
"Green Patches" 1.0 0 -15040220 true "" "plot count green-patches"
"Blue Patches" 1.0 0 -14070903 true "" "plot count blue-patches"
"Yellow Patches" 1.0 0 -4079321 true "" "plot count yellow-patches"
"Red Patches " 1.0 0 -5298144 true "" "plot count red-patches"
...
"" ""
PENS
"Green Clan" 1.0 0 -15040220 true "" "plot count green-agent"
"Blue Clan" 1.0 0 -14730904 true "" "plot count blue-agent"
"pen-2" 1.0 0 -4079321 true "" "plot count yellow-agent "
"pen-3" 1.0 0 -2674135 true "" "plot count red-agent "
...
"" ""
PENS
"default" 1.0 0 -15040220 true "" "plot green-resources"
"pen-1" 1.0 0 -14985354 true "" "plot blue-resources "
"pen-2" 1.0 0 -4079321 true "" "plot yellow-resources"
"pen-3" 1.0 0 -2674135 true "" "plot red-resources"
...
@#$#@#$#@
<experiments>
  <experiment name="Blue_not_Green_not-v1_05_07_2025" repetitions="20" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>not any? turtles</exitCondition>
    <metric>count green-patches</metric>
    <runMetricsCondition>(tick mod 50 = 0)</runMetricsCondition>
    <enumeratedValueSet variable="num-green-clan">
      <value value="15"/>
      <value value="20"/>
      <value value="25"/>
      <value value="30"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="green-hostile?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="yellow-hostile?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="red-hostile?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="num-red-clan">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="blue-hostile?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="num-blue-clan">
      <value value="15"/>
      <value value="20"/>
      <value value="25"/>
      <value value="30"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="num-yellow-clan">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
